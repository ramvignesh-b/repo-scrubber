...
> v1: This app was primarily built on Angular (13) and Bootstrap 5, hosted on GitHub, and is served via Cloudflare Pages.
> v2: This app was rewritten on Angular (22) and uses [primer](https://primer.style)
